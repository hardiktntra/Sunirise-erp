...
public class Pavillionopenpage extends Base {
	...
	@FindBy(xpath= "//span[text()='Pavillion Open']")
	WebElement PavillionOpen;
	
	public Pavillionopenpage()
	{
	...
	public void navigate_to_module() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		action.moveToElement(PavillionOpen).click().perform();
