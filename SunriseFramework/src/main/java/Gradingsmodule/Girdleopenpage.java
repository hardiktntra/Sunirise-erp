...
public class Girdleopenpage extends Base {
	...
	@FindBy(xpath= "//span[text()='Girdle Open']")
	WebElement Girdleopen;
	
	public Girdleopenpage()
	{
	...
	public void navigate_to_module() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		action.moveToElement(Girdleopen).click().perform();
