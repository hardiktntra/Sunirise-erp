...
public class Tablewhitepage extends Base{
	...
	@FindBy(xpath= "//span[text()='Table White']")
	WebElement TableWhite;
	
	public Tablewhitepage()
	{
	...
	public void navigate_to_module() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		action.moveToElement(TableWhite).click().perform();
