...
public class Tableblackpage extends Base{
	...
	@FindBy(xpath= "//span[text()='Table Black']")
	WebElement Tableblack;
	
	public Tableblackpage()
	{
	...
	public void navigate_to_module() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		action.moveToElement(Tableblack).click().perform();
