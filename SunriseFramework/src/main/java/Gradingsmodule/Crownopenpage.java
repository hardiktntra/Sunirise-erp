...
public class Crownopenpage extends Base{
	...
	@FindBy(xpath= "//span[text()='Crown Open']")
	WebElement CrownOpen;
	
	public Crownopenpage()
	{
	...
	public void navigate_to_module() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		action.moveToElement(CrownOpen).click().perform();
